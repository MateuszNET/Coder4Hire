...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Coder4Hire - Scripts</title>
	...
	<body>
		...
		<div id='container' class="container" style="background-color: #FFFFFF;border-radius:5px;">
			...
			<div class='span2'>
					<a href='new_script.php'> <button class="btn btn-primary" type="button">Submit A Script</button></a>
			</div>
			<table id='scripts' summary='GMod Scripts' class="table table-striped">
				...
				<tbody>
				<?php
					buildscripttable(200,$Steam->response->players[0]->steamid);
				?>
				</tbody>
			</table>
		</div> <!-- /container -->
