...
$BACKUP_DEST = '/var/www/html/Coder4Hire/CRON/db_backups';
...
$BACKUP_NAME = 'C4H_backup_' . date('Y-m-d');
...
$EXCLUDE_DB = 'information_schema,TcAdmin,GamePanelX,mortuus_GS-1,mysql';
